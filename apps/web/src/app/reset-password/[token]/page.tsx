            ...
            <div className="max-w-md w-full bg-white rounded-[2.5rem] shadow-2xl p-10 relative overflow-hidden">
                ...
                <header className="text-center mb-8">
                    <h1 className="text-3xl font-black text-votorantim-blue uppercase italic tracking-tighter">
                        NOVA <span className="text-votorantim-green whitespace-nowrap">SENHA</span>
                    </h1>
                ...
                {message ? (
                    <div className="text-center py-10">
                        ...
                        <p className="text-votorantim-blue font-bold mb-4">{message}</p>
                    ...
                    <form onSubmit={handleSubmit} className="space-y-6">
                        ...
                        <button
                            type="submit"
                            disabled={loading}
                            className="w-full bg-votorantim-green text-votorantim-blue py-5 rounded-2xl font-black text-xs uppercase tracking-[0.2em] shadow-xl shadow-votorantim-green/20 hover:scale-[1.02] active:scale-[0.98] transition-all disabled:opacity-50"
                        >
