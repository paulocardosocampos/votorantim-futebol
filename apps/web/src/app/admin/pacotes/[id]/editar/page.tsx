...
export default function EditarPacotePage() {
    ...
    if (loading) return <div className="p-20 text-center animate-pulse font-black text-votorantim-blue uppercase">Buscando dados do pacote...</div>;
        ...
        <div className="min-h-screen bg-gray-50 pb-20 font-sans">
            <nav className="bg-votorantim-blue p-4 text-white shadow-xl">
                <div className="max-w-4xl mx-auto flex items-center px-4">
                    ...
                    <h1 className="text-xl font-black uppercase tracking-tight">Editar <span className="text-votorantim-green">Pacote</span></h1>
                </div>
            </nav>
            ...
            <main className="max-w-4xl mx-auto p-4 mt-8">
                <form onSubmit={handleSubmit} className="space-y-8">
                    ...
                    <section className="bg-white p-8 rounded-[2rem] shadow-2xl border border-gray-100">
                        <h3 className="text-lg font-black text-votorantim-blue uppercase mb-6 flex items-center tracking-tight">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="md:col-span-2">
                                ...
                                <input name="title" required value={form.title} onChange={handleChange} className="w-full bg-gray-50 border-2 border-gray-50 rounded-xl px-4 py-3 focus:bg-white focus:border-votorantim-blue transition-all font-medium" />
                            </div>
                            <div>
                                <label className="block text-[10px] font-black text-gray-400 uppercase tracking-widest mb-2">Campeonato</label>
                                <input name="championship" required value={form.championship} onChange={handleChange} className="w-full bg-gray-50 border-2 border-gray-50 rounded-xl px-4 py-3 focus:bg-white focus:border-votorantim-blue transition-all font-medium" />
                            </div>
                            <div>
                                <label className="block text-[10px] font-black text-gray-400 uppercase tracking-widest mb-2">Confronto (Jogo)</label>
                                <input name="teamMatch" required value={form.teamMatch} onChange={handleChange} className="w-full bg-gray-50 border-2 border-gray-50 rounded-xl px-4 py-3 focus:bg-white focus:border-votorantim-blue transition-all font-medium" />
                            </div>
                            <div>
                                <label className="block text-[10px] font-black text-gray-400 uppercase tracking-widest mb-2">Data e Hora</label>
                                <input name="eventDate" type="datetime-local" required value={form.eventDate} onChange={handleChange} className="w-full bg-gray-50 border-2 border-gray-50 rounded-xl px-4 py-3 focus:bg-white focus:border-votorantim-blue transition-all font-medium" />
                            </div>
                            <div>
                                <label className="block text-[10px] font-black text-gray-400 uppercase tracking-widest mb-2">Local / Estádio</label>
                                <input name="location" required value={form.location} onChange={handleChange} className="w-full bg-gray-50 border-2 border-gray-50 rounded-xl px-4 py-3 focus:bg-white focus:border-votorantim-blue transition-all font-medium" />
                            </div>
                        </div>
                    </section>
                    ...
                    <section className="bg-white p-8 rounded-[2rem] shadow-2xl border border-gray-100">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div>
                                <label className="block text-[10px] font-black text-gray-400 uppercase tracking-widest mb-2">Preço em Coins</label>
                            ...
                            <div className="md:col-span-2">
                                ...
                                <input name="imageUrl" value={form.imageUrl} onChange={handleChange} className="w-full bg-gray-50 border-2 border-gray-50 rounded-xl px-4 py-3 focus:bg-white focus:border-votorantim-blue transition-all" />
                            </div>
                        </div>
                    </section>
                    ...
                    <button
                        type="submit"
                        disabled={saving}
                        className="w-full bg-votorantim-blue text-white py-6 rounded-[2.5rem] font-black text-xl shadow-2xl shadow-votorantim-blue/30 hover:scale-[1.02] active:scale-[0.98] transition-all disabled:opacity-50 uppercase tracking-widest"
                    >
