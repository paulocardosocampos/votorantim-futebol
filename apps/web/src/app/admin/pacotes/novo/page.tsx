                    ...
                    <section className="bg-white p-8 rounded-3xl shadow-xl border border-gray-100">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            <div className="md:col-span-2">
                                ...
                                <input name="title" required value={form.title} onChange={handleChange} className="w-full bg-gray-50 border-2 border-gray-50 rounded-xl px-4 py-3 focus:bg-white focus:border-votorantim-blue transition-all" placeholder="Ex: Super Clássico VIP em São Paulo" />
                            </div>
                            <div>
                                <label className="block text-[10px] font-black text-gray-400 uppercase tracking-widest mb-2">Campeonato</label>
                                <input name="championship" required value={form.championship} onChange={handleChange} className="w-full bg-gray-50 border-2 border-gray-50 rounded-xl px-4 py-3 focus:bg-white focus:border-votorantim-blue transition-all" placeholder="Ex: Brasileirão 2026" />
                            </div>
                            <div>
                    ...
                    <section className="bg-white p-8 rounded-3xl shadow-xl border border-gray-100">
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div className="md:col-span-2">
                                ...
                                <textarea name="description" rows={3} value={form.description} onChange={handleChange} className="w-full bg-gray-50 border-2 border-gray-50 rounded-xl px-4 py-3 focus:bg-white focus:border-votorantim-blue transition-all" placeholder="Informações detalhadas sobre o pacote..." />
                            </div>
                            <div className="md:col-span-2">
                                ...
                                <p className="text-[9px] text-gray-400 mt-2 italic">* Caso em branco, usaremos uma imagem padrão de futebol.</p>
                            </div>
                        </div>
                    </section>
