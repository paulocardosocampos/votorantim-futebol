...
export default function AdminOrdersPage() {
    ...
    if (loading || !user) return <div className="p-20 text-center animate-pulse font-black text-votorantim-blue uppercase">Carregando gestão de pedidos...</div>;
        ...
        <div className="min-h-screen bg-gray-50">
            <nav className="bg-votorantim-blue p-4 text-white shadow-xl">
                <div className="max-w-7xl mx-auto flex justify-between items-center px-4">
                    <div className="flex items-center">
                        ...
                        <h1 className="text-xl font-bold uppercase tracking-tighter">CMS <span className="text-votorantim-green font-black">Pedidos</span></h1>
                    </div>
                    <div className="flex items-center space-x-8">
                        ...
                        <button onClick={() => router.push('/admin/pedidos')} className="text-xs font-black uppercase tracking-widest text-votorantim-green border-b-2 border-votorantim-green">Pedidos</button>
            ...
            <main className="max-w-7xl mx-auto p-4 sm:p-8">
                <header className="mb-10">
                    <h2 className="text-3xl font-black text-votorantim-blue uppercase tracking-tight">Gestão de Resgates</h2>
                ...
                <div className="bg-white rounded-[2rem] shadow-2xl overflow-hidden border border-gray-100">
                    <table className="w-full text-left border-collapse">
                        ...
                        <tbody className="divide-y divide-gray-50">
                            {orders.map((order) => (
                                <tr key={order.id} className="hover:bg-votorantim-blue/[0.01]">
                                    <td className="px-8 py-6">
                                        <p className="font-black text-votorantim-blue uppercase text-sm">{order.user.name}</p>
                                    ...
                                    <td className="px-8 py-6 font-black text-votorantim-blue">
                                        {order.totalCoins}
                                    </td>
                                    <td className="px-8 py-6">
                                        ...
                                        {order.status === 'PENDING' && (
                                            <>
                                                <button
                                                    ...
                                                    className="bg-votorantim-green text-votorantim-blue px-4 py-2 rounded-lg text-xs font-black uppercase hover:scale-105 transition-all"
                                                >
                                                    Atender
                                                </button>
                                                <button
