...
export default function MeusResgatesPage() {
    ...
    if (loading || !user) return <div className="p-20 text-center animate-pulse font-black text-votorantim-blue uppercase tracking-widest">Carregando seus resgates...</div>;
        ...
        <div className="min-h-screen bg-gray-50">
            <nav className="bg-votorantim-blue p-4 text-white shadow-lg sticky top-0 z-50">
                <div className="max-w-7xl mx-auto flex justify-between items-center px-4">
                    <div className="flex items-center">
                        ...
                        <h1 className="text-xl font-bold uppercase tracking-tight">Meus <span className="text-votorantim-green font-black">Resgates</span></h1>
                    </div>
                    <button
            ...
            <main className="max-w-5xl mx-auto p-4 sm:p-8">
                <header className="mb-10 text-center sm:text-left">
                    <h2 className="text-4xl font-black text-votorantim-blue uppercase tracking-tighter">Acompanhamento</h2>
                ...
                {orders.length === 0 ? (
                    <div className="bg-white rounded-[2rem] p-20 text-center shadow-xl border border-gray-100">
                        <div className="bg-votorantim-blue/5 w-20 h-20 rounded-full flex items-center justify-center mx-auto mb-6">
                            <svg className="w-10 h-10 text-votorantim-blue/20" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2L2 7l10 5 10-5-10-5zM2 17l10 5 10-5M2 12l10 5 10-5" /></svg>
                        </div>
                        <p className="text-gray-400 text-lg font-bold">Você ainda não realizou nenhum resgate.</p>
                        <button
                            className="mt-6 bg-votorantim-blue text-white px-8 py-3 rounded-2xl font-black uppercase text-xs tracking-widest hover:scale-105 transition-all shadow-lg"
                            ...
                            <div key={order.id} className="bg-white rounded-[2rem] p-6 sm:p-8 shadow-xl border border-gray-100 flex flex-col sm:flex-row items-center sm:items-stretch gap-6 group hover:shadow-2xl transition-all">
                                ...
                                <div className="w-full sm:w-48 h-32 bg-gray-100 rounded-2xl overflow-hidden flex-shrink-0 relative">
                                    {order.package.imageUrl ? (
                                        ...
                                        <div className="w-full h-full bg-votorantim-blue flex items-center justify-center text-white/10 text-xs">
                                            SEM IMAGEM
                                        </div>
                                    )}
                                    <div className="absolute top-2 left-2">
                                        <span className="bg-votorantim-green text-white text-[8px] font-black px-2 py-0.5 rounded-full uppercase tracking-tighter shadow-sm">
                                ...
                                <div className="flex-grow flex flex-col justify-center text-center sm:text-left">
                                    <h3 className="text-xl font-black text-votorantim-blue uppercase leading-tight">{order.package.teamMatch}</h3>
                                ...
                                <div className="flex flex-col items-center sm:items-end justify-center sm:border-l border-gray-50 sm:pl-8 flex-shrink-0">
                                    ...
                                    <p className="text-2xl font-black text-votorantim-blue leading-none">{order.totalCoins} <span className="text-xs text-votorantim-green font-bold">COINS</span></p>
